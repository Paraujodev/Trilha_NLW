...
export function Ranking (){
    return(
        ...
        <div className="space-y-4">
          <div className="relative rounded-xl bg-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">1ª</span> | Diego Fernandes
            </span>
        ...
        <div className="space-y-4">
          <div className="relative rounded-xl bg-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">2ª</span> | Diego Fernandes
            </span>
        ...
        <div className="space-y-4">
          <div className="relative rounded-xl bg-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">3ª</span> | Diego Fernandes
            </span>
